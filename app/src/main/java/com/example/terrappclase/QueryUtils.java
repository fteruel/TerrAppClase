...
public class QueryUtils {
    ...
    private static String KEY_MAGNITUD = "mag";
    private static String KEY_LUGAR = "place";
    private static String KEY_FECHA = "time";
    ...
    public static ArrayList<Terremoto> extractTerremotos(){
        ...
        JSONObject terremotoJSON = null;
        try {
            terremotoJSON = new JSONObject(SAMPLE_JSON_RESPONSE);
            ...
            for( int i = 0 ; i < terremotoArray.length() ; i ++){
                ...
                //TODO agragar la URl a lo que se carga

                Double magnitudActual = propiedades.getDouble(KEY_MAGNITUD);
                String LugarActual = propiedades.getString(KEY_LUGAR);
                Long FechaActual = propiedades.getLong(KEY_FECHA);



                Terremoto terremoto = new Terremoto(magnitudActual,LugarActual, FechaActual);
